...
const NOTE_PARTS: Record<string, string[]> = {
  ...
  copyrightGenie: [
    ...
    "<a href='#' data-tab='genie'>Copyright Compiler</a>.",
    "</p>",
  ],
  ...
  protected: [
    ...
    "<a href='#' data-tab='fairuse'>Fair Use Evaluator</a>], Educational exemptions [See",
    "the <a href='#' data-tab='instructors'>Exceptions for Educators eTool</a>], Library or",
    "archival exceptions [See <a href='#' data-tab='spinner'>Section 108 Spinner</a>],",
